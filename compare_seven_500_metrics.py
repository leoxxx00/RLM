#!/usr/bin/env python3
"""Compare the seven full 500-row NQ RAG/RLM outputs and make plots.
...
Outputs:
    nq_clean_monitor_exports/seven_models_500_metrics/
"""
...
DEFAULT_OUT_DIR = PROJECT_DIR / "nq_clean_monitor_exports" / "seven_models_500_metrics"
...
def save_bar_chart(summary: pd.DataFrame, metrics: list[str], path: Path) -> None:
    ...
    ax.set_title("Seven 500-row model comparison")
    ax.set_ylabel("Score")
    ax.set_ylim(0, 1.0)
    ax.set_xticks(x)
...
def write_outputs(df: pd.DataFrame, summary: pd.DataFrame, out_dir: Path) -> None:
    ...
    rows_path = out_dir / "seven_models_500_trace_rows_long.csv"
    summary_path = out_dir / "seven_models_500_summary.csv"
    chart_ready_path = out_dir / "seven_models_500_chart_ready_long.csv"
    ...
    save_bar_chart(summary, PLOT_METRICS, out_dir / "seven_models_500_quality_metrics.png")
    save_fused_chart(summary, out_dir / "seven_models_500_balanced_fused_score.png")
    save_runtime_chart(summary, out_dir / "seven_models_500_runtime.png")
    save_short_vs_long_chart(summary, out_dir / "seven_models_500_short_vs_long_f1.png")
    save_metric_heatmap(summary, out_dir / "seven_models_500_metric_heatmap.png")
    save_rank_chart(summary, out_dir / "seven_models_500_ranked_fused_score.png")
    save_fused_vs_runtime_chart(summary, out_dir / "seven_models_500_fused_vs_runtime.png")
    save_fused_components_chart(summary, out_dir / "seven_models_500_fused_components.png")
    save_distribution_boxplot(df, "short_f1", out_dir / "seven_models_500_short_f1_distribution.png")
    save_distribution_boxplot(df, "long_f1", out_dir / "seven_models_500_long_f1_distribution.png")
    save_distribution_boxplot(df, "balanced_fused_score", out_dir / "seven_models_500_fused_distribution.png")
    save_judge_distribution_chart(df, out_dir / "seven_models_500_judge_distribution.png")
    save_win_count_chart(df, out_dir / "seven_models_500_per_question_win_count.png")
...
def main() -> None:
    ...
    print("\n=== Seven full 500-row model summary ===")
    print(
        summary[
            [
                "model",
